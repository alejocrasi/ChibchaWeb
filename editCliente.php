    ...
    $.ajax({
        ...
        data = JSON.parse(data);    
            if (data["status"] == 1) {
                ...
                var econtro = false;
                while(econtro==false){
                  if(data[i]["cod_cliente"]=='<?php echo $cod_cliente ?>'){
                   econtro=true;    
                ...
                var html ='<div class="form-group row showcase_row_area">'+
                          ...
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="cod_cliente" id="cod_cliente" value ="'+data[i]["cod_cliente"]+'" readonly style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        ...
                        '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="nom_cliente" id="nom_cliente" value ="'+data[i]["nom_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                        '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="ape_cliente" id="ape_cliente" value ="'+data[i]["ape_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                          '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" id="cc_cliente" name="cc_cliente" value ="'+data[i]["cc_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                          '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" id="dir_cliente" name="dir_cliente" value ="'+data[i]["dir_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                          '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="email" class="form-control" id="correo_cliente" name="correo_cliente" value ="'+data[i]["correo_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                        '<div class="col-md-5 showcase_text_area">'+
                          ...
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="password_cliente" id="password_cliente" value ="'+data[i]["password_cliente"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                        '<div class="col-md-5 showcase_text_area">'+
                            '<label for="text">tarjeta de credito</label>'+
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="tarjeta_credito" id="tarjeta_credito" value ="'+data[i]["tarjeta_credito"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                        '<div class="col-md-5 showcase_text_area">'+
                            '<label for="text">tipo de membresia</label>'+
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="tipo_membresia" id="tipo_membresia" value ="'+data[i]["tipo_membresia"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-group row showcase_row_area">'+
                        '<div class="col-md-5 showcase_text_area">'+
                            '<label for="text">plan de pago</label>'+
                          '</div>'+
                          '<div class="col-md-20 showcase_content_area">'+
                            '<input type="text" class="form-control" name="plan_pago" id="plan_pago" value ="'+data[i]["plan_pago"]+'" style="width:180%;">'+
                          '</div>'+
                        '</div>'+
