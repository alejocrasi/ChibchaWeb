...
while($stmt -> fetch()) {
    $entro=true;
    $html.='<form action="javascript:void(0);" onsubmit="applyAtVacant('.$_POST['cod'].');" >
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-warning">Aplicar <i class="mdi mdi-human-greeting"></i></button>
                </div>
            </form>'
